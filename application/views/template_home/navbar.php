                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                                <ul class="nav navbar-nav navbar-right">
                                    <?php
                                    if (!$this->session->userdata('username') && $this->session->userdata('nidn_dosen') && $this->session->userdata('nisn_siswa')) : ?>
                                        <li>
                                            <a class="page-scroll" href="<?= base_url()  ?>">Home</a>
                                        </li>
                                    <?php endif; ?>
                                    <li>
                                        <a class="page-scroll" href="#services">Tentang POLINDRA</a>
                                    </li>
                                    <li>
                                    ...
                                    <?php elseif ($this->session->userdata('nidn_dosen')) : ?>
                                        <li>
                                            <a class="page-scroll" href="<?= base_url('dosen') ?>">[ Halaman Dosen ]</a>
                                        </li>
