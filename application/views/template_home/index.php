                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Sejarah</h4>
                                    <p>
                                        Berdiri pada tahun 2008 dan diresmikan oleh Presiden Republik Indonesia Dr. Susilo Bambang Yudhoyono
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                        ...
                        <div class="about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Perguruan Tinggi Negeri</h4>
                                    <p>
                                        Perguruan Tinggi Negeri yang pertama di Kabupaten Indramayu
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class=" about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    <a class="services-icon">
                                        <i class="fa fa-bicycle"></i> <i class="fa fa-motorcycle"></i> <i class="fa fa-car"></i>
                                    </a>
                                    <h4>Lahan Parkir</h4>
                                    <p>
                        ...
                        <div class=" about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Kejuaraan</h4>
                                    <p>
                                        Memenangkan banyak kejuaraan dalam lomba Kabupaten,Provinsi,Nasional maupun Internasional
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                        ...
                        <div class=" about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <p>
                                        Lulusan POLINDRA bukan lulusan biasa
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                        ...
                        <div class=" about-move">
                            <div class="services-details">
                                <div class="single-services">
                                    ...
                                    <h4>Keamanan</h4>
                                    <p>
                                        Keamanan 24 Jam dengan penjagaan ketat 10 Satpam
                                    </p>
                                </div>
                            </div>
                            <!-- end about-details -->
                ...
                <div class="team-top">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url('assets_home/') ?>img/team/1.jpg" alt="">
                                </a>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url('assets_home/') ?>img/team/2.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url('assets_home/') ?>img/team/3.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="single-team-member">
                            <div class="team-img">
                                <a href="#">
                                    <img src="<?= base_url('assets_home/') ?>img/team/4.jpg" alt="">
                                </a>
                                <div class="team-social-icon text-center">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 design development">
                        <div class="single-awesome-project">
                            <div class="awesome-img">
                                <a href="#"><img src="<?= base_url('assets_home/') ?>img/portfolio/Robotika Polindra.png" alt="" /></a>
                                <div class="add-actions text-center">
                                    <div class="project-dec">
                                        <a class="venobox" data-gall="myGallery" href="<?= base_url('assets_home/') ?>img/portfolio/Robotika Polindra.png">
                                            <h4>ROBOTIKA</h4>
                                            UKM ROBOTIKA
                                        </a>
                                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    Email: info@polindra.ac.id<br>
                                    <span>Web: www.polindra.ac.id</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    Alamat: Jl. Raya Lohbener Lama No. 08 Indramayu<br>
                                    <span>ID 45252, Indramayu, Jawa Barat</span>
                                </p>
                            </div>
                        </div>
                    </div>
