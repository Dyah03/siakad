...
<h5>Portal Akademik untuk Mahasiswa</h5>
<br>
<p>Selamat datang di Portal Akademik untuk Mahasiswa ini. Portal Akademik ini digunakan oleh mahasiswa untuk memudahkan akses terhadap informasi - informasi akademik melalui internet.
<br>
...
Selamat menggunakan fasilitas ini dengan baik dan bijaksana.</p>
</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">Jumlah Dosen</p>
