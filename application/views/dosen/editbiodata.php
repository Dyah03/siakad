...
<div class="container">
	...
	<form action = "<?php echo base_url("dosen/editbiodata") ?>" method = "post" enctype = "multipart/form-data">


		<div class="form-group">
			<label for="nidn_dosen">NIDN :</label>
			<input type="text" class="form-control" name="nidn_dosen" value="">
		</div>
		...
		<div class="form-group">
			...
			<img src="<?php echo base_url('foto/dosen/') ?>" width="64" />
		</div>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="container-fluid">
		<div class="panel-button-tab-left">				
			<form method="post"  action="<?= $this->session->userdata("id_dosen"); ?>">
			</form>
		</div>
		<br>

		<form action="<?php echo base_url("dosen/updateProfile")?>" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id_dosen" value="" />
						<div class="col-md-8">
							<div class="form-group">
								<label for="nidn">NIDN :</label>
								<input type="text" class="form-control" name="nidn_dosen" value="<?= $this->session->userdata("nidn_dosen"); ?>">
							</div>
						</div>
						<div class="col-md-8">
							<div class="form-group">
                ...
                <div class=col-md-12>      
				<button type="submit" class="btn btn-primary" href="<?= base_url();?>dosen/biodata">Simpan</a></button>
				<button type="reset" class="btn btn-danger" href="<?= base_url();?>dosen/biodata">Reset</a></button>
